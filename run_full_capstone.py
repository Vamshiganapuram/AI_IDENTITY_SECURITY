...
Runs:
- Project 1: Threat Model & Architecture
- Project 2: IAM & Auth0 Identity Controls
- Project 3: Red Team AI Identity Attacks
- Project 4: Blue Team Defenses & Guardrails
- Project 5: Governance & Compliance Mapping
"""
import time
import os
import sys
