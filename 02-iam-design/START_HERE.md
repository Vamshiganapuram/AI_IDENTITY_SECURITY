...
**Full capstone (Projects 1–4, every screenshot, every command):** open `COMPLETE_WALKTHROUGH.md` and follow it from Part A to Part G.

The rest of this file is Project 2 only.
